...
//    ArrayList<HoaDon> arr = new ArrayList<HoaDon>();
     ...
     */
    private HoaDonDao dao1 = new HoaDonDao();
    private List<HoaDon> list1 = dao1.selectAll();
...
//            cell.setCellValue("Ngày lập");
    ...
    private void tong() {
        ...
        for (int i = 0; i < tblHoaDon.getRowCount(); i++) {
            double soluong = Double.parseDouble(tblHoaDon.getValueAt(i, 5).toString());
            double giatien = Double.parseDouble(tblHoaDon.getValueAt(i, 6).toString());

            double tich = soluong * giatien;

            tong += tich;
        }

        txtTong.setText(x.format(tong) + " VND");
    }
    ...
    private void initComponents() {
        ...
        tblHoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã hoá đơn", "Mã  khách hàng ", "Mã sản phẩm", "Tên sản Phẩm ", "Loại ", "Số lượng", "Giá "
            }
        ) {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtTong, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(43, 43, 43))))
        );
