...
public final class QuanLySanPham extends javax.swing.JFrame {
    ...
    public boolean check() {
        if (txtMaSP.getText().equals("") || txtTenSP.getText().equals("") || txtGia.getText().equals("")
                || txtSL.getText().equals("") || tatMoTa.getText().equals("")|| txtLoai.getText().equals("")) {
    ...
    SanPham getModel() {
        ...
        model.setLoai(String.valueOf(txtLoai.getText()));
...
//        btnStudents.setVisible(!insertable);
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtSL, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(49, 49, 49)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        tblDanhSach.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã sản phẩm", "Tên sản phẩm", "Giá", "Số lượng", "Mô tả", "Loại", "Hình ảnh"
            }
        ));
